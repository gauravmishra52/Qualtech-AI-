...
public class AdvancedFaceDetail {
    ...
    public boolean isLikelySpoof() {
        return spoofProbability != null && spoofProbability > 0.6;
    }
    ...
    public String getConfidenceLevel() {
        if (spoofProbability == null) return "Unknown";
        
        if (spoofProbability < 0.2) return "High Confidence";
        if (spoofProbability < 0.4) return "Medium Confidence";
        if (spoofProbability < 0.6) return "Low Confidence";
